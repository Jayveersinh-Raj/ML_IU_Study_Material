You can plot the `learning curve` by recording the `model.fit` in a variable, and plotting it against epochs. Iterations and epochs are terms that could be used
interchangeably.
